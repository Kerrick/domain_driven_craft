...
It bridges the gap between standard *Domain-Driven Design* (Evans/Vernon)
...
primary source of truth for the *Physical World* Bounded Context.
...
2.  **The Read Model (External Platform):**
    ...
    -   Role: Powers the Web Dashboard, Leaderboards, and Discord
        integrations. It is *Eventually Consistent*.
