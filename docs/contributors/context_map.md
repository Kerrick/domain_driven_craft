...
The core domain. This is the experience of running and playing on
a small, shared Minecraft server with friends. It's the *social contract*
...
Some concepts genuinely mean the same thing across two contexts. These
...
- **Community Server:** The *place* — "our world," the shared map, the
  experience you get to have by connecting
- **Server Operations:** The *data* — a directory of files to back up,
  restore, and protect
- **Minecraft Platform:** The *state* — the global object that holds all
