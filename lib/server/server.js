...
export class Server {
  ...
  get fasttickDuration() { return this.#settings.fasttickDuration; }
  set fasttickDuration(seconds) { this.#settings.fasttickDuration = seconds; }
  ...
  recalculateDifficulty() {
    ...
    const target = needsPeaceful ? "peaceful" : this.#settings.baseDifficulty;
