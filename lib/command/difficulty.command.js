...
import { DIFFICULTY_PATTERN } from "../types/difficulty.js";

const DURATION_SECONDS = 900;

export class DifficultyCommand {
  static pattern = DIFFICULTY_PATTERN;
  static help = { usage: "!difficulty <level>", description: "Vote to change difficulty" };
