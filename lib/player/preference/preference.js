...
export class Preference {
  ...
  get storedValue() { return world.getDynamicProperty(this.#key) }
  set storedValue(val) { world.setDynamicProperty(this.#key, val) }

  get formatted() {
    throw new Error('Subclass must implement formatted')
  }

  asReadonly() { return new ReadonlyPreference(this.#name, this.formatted, this.#command) }
}
